...
$(document).ready(function() {
  ...
  $("#NonFiction_button").click(function() {
    //$("article").css("display", "none");
    //$("article").hide(500);
    $("#NonFiction").css("display", "inline-block");
  });

  $("#Autobio_button").click(function() {
    $(".content").css("display", "none");
    $(".Autobuography").css("display", "inline-block");
  })
  ...
  $("#Poetry_button").click(function() {
    $(".content").css("display", "none");
    $(".Poetry").css("display", "inline-block");
  });
